...
ok(html.includes('name="divina-work13" content="V621"') && html.includes('V621-CONSULTAS-TEMPLO-DO-ENCONTRO'), 'release V621');
ok(html.includes('app-v208.js?v=621-consultas-templo-do-encontro'), 'app V621');
...
ok(app.includes("document.documentElement.dataset.work13Macro = 'consultas-templo-do-encontro'"), 'macroetapa ativa');
