...
const cacheName = 'divina-bruxa-work13-v610-biblioteca-soul';
const harness = createHarness();

check('core:fifty-five-assets-declared', coreAssets.length === 55, coreAssets.length);
...
check('install:fifty-five-core-assets', cache?.size === 55, cache?.size);
...
check('message:status-fifty-five-assets', harness.sourceMessages.some(item => item.core?.length === 55));
