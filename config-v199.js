export const CONFIG=Object.freeze({
  ...
  services:[
    ...
    {name:'Leitura de Mente',price:200,description:'Leitura simbólica da dinâmica, intenções e padrões da relação.'},
    {name:'Carta de Conselho',price:150,description:'Uma carta, uma questão e uma orientação objetiva.'},
