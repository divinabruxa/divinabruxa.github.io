/* DIVINA BRUXA — FECHAMENTO SUPREMO · QA RUNTIME · MENU V630 */
...
const menuModule=await import(`${pathToFileURL(path.join(root,'orbital-menu-v502.js')).href}?qa=v630-runtime-${Date.now()}`);
...
check('status:v630',status.release==='V630-FECHAMENTO-SUPREMO'&&status.version===630);
...
console.log(JSON.stringify({
  release:'V630',phase:'FECHAMENTO-SUPREMO',scope:'menu-runtime',
