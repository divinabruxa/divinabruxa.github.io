...
ok(html.includes('content="V625"') && html.includes('V625-MUSICA-PALCO-DAS-ESTRELAS'), 'release cumulativa V625');
...
ok(sw.includes("CACHE_NAME = 'divina-bruxa-work13-v625-musica-palco-das-estrelas'"), 'cache cumulativo próprio');
