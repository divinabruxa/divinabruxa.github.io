...
ok(html.includes('content="V622"') && html.includes('V622-LOJA-CASA-DAS-ESCOLHAS-VIVAS'), 'release cumulativa V622');
...
ok(sw.includes("CACHE_NAME = 'divina-bruxa-work13-v622-loja-casa-das-escolhas-vivas'"), 'cache cumulativo próprio');
