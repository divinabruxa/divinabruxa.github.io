...
ok(html.includes('content="V624"') && html.includes('V624-CONTA-CASA-DO-RETORNO'), 'release cumulativa V624');
...
ok(sw.includes("CACHE_NAME = 'divina-bruxa-work13-v624-conta-casa-do-retorno'"), 'cache cumulativo próprio');
