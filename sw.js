/* DIVINA BRUXA 2.0 — FLUIDEZ SUPREMA · LINGUAGEM VIVA · CACHE V585
...
const SHELL_CACHE='divina-bruxa-v585-shell';
const CONTENT_CACHE='divina-bruxa-v585-content';
const IMAGE_CACHE='divina-bruxa-v585-images';
const OFFLINE_CACHE='divina-bruxa-v585-offline-core';
const PREMIUM_CACHE='divina-bruxa-v585-premium-static';
...
// falhar, a V585 não assume o controle e o worker anterior continua íntegro.
...
const appShellIsValid=async(url,response)=>{
  ...
  return html.length>1024&&/id=["']app["']/.test(html)&&/id=["']home["']/.test(html)&&/app-v208\.js\?v=585-linguagem-viva/.test(html);
};
...
self.addEventListener('fetch',event=>{
  ...
  if(RELEASE_CRITICAL_PATTERN_V585.test(url.pathname)){
