/* DIVINA BRUXA 2.0 — MACROETAPA 1 · ORBE OS / TAROT LIVRE V514
...
const SHELL_CACHE='divina-bruxa-v514-shell';
const CONTENT_CACHE='divina-bruxa-v514-content';
const IMAGE_CACHE='divina-bruxa-v514-images';
const OFFLINE_CACHE='divina-bruxa-v514-offline-core';
...
const REQUIRED_SHELL=Object.freeze([
  ...
  './tarot-livre-orbe-os-v514.js','./tarot-livre-orbe-os-v514.css','./tarot-cosmos-deep-v514.webp',
