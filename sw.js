/* DIVINA BRUXA 2.0 — FLUIDEZ SUPREMA · UNIVERSO VIVO GLOBAL · CACHE V581
...
const SHELL_CACHE='divina-bruxa-v581-shell';
const CONTENT_CACHE='divina-bruxa-v581-content';
const IMAGE_CACHE='divina-bruxa-v581-images';
const OFFLINE_CACHE='divina-bruxa-v581-offline-core';
const PREMIUM_CACHE='divina-bruxa-v581-premium-static';
...
const RELEASE_CRITICAL_PATTERN_V581=/(?:^|\/)(?:app-v208|experience-message-governor-v580|living-universe-core-v524|orb-engine-v208|page-loader-v1|orb-persistent-journey-v565|orb-universal-presence-v526|orbital-menu-v502|supreme-orb-core-v501|tarot-livre-orbe-os-v517|whit-core-supreme-v527|whit-orb-soul-bridge-v581|whit-presence-v307|whit-signature-v311)\.js$/;
...
const REQUIRED_SHELL=Object.freeze([
  ...
  './app-v208.js','./experience-message-governor-v580.js','./whit-orb-soul-bridge-v581.js','./navigation.js','./route-registry-v180.js','./page-loader-v1.js',
...
// falhar, a V581 não assume o controle e o worker anterior continua íntegro.
...
const appShellIsValid=async(url,response)=>{
  ...
  return html.length>1024&&/id=["']app["']/.test(html)&&/id=["']home["']/.test(html)&&/app-v208\.js\?v=581/.test(html);
};
...
self.addEventListener('fetch',event=>{
  ...
  if(RELEASE_CRITICAL_PATTERN_V581.test(url.pathname)){
