/* DIVINA BRUXA 2.0 — ESSÊNCIA SUPREMA · MACROETAPA 2 · MENU DA ORBE · CACHE V579
...
const SHELL_CACHE='divina-bruxa-v579-shell';
const CONTENT_CACHE='divina-bruxa-v579-content';
const IMAGE_CACHE='divina-bruxa-v579-images';
const OFFLINE_CACHE='divina-bruxa-v579-offline-core';
const PREMIUM_CACHE='divina-bruxa-v579-premium-static';
...
const RELEASE_CRITICAL_PATTERN_V579=/(?:^|\/)(?:app-v208|navigation|menu-completo-v177|orb-engine-v208|page-loader-v1|orb-persistent-journey-v565|orb-universal-presence-v526|orbital-menu-v502|supreme-orb-core-v501|tarot-livre-orbe-os-v517)\.js$/;
...
// falhar, a V579 não assume o controle e o worker anterior continua íntegro.
...
const appShellIsValid=async(url,response)=>{
  ...
  return html.length>1024&&/id=["']app["']/.test(html)&&/id=["']home["']/.test(html)&&/app-v208\.js\?v=579-menu/.test(html)&&/divina-essence-release["'] content=["']V579/.test(html)&&/data-macroetapa=["']2-menu-orbe/.test(html)&&/home-essence-v578/.test(html);
};
...
self.addEventListener('fetch',event=>{
  ...
  if(RELEASE_CRITICAL_PATTERN_V579.test(url.pathname)){
