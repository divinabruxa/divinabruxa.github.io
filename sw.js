/* DIVINA BRUXA 2.0 — ESSÊNCIA SUPREMA · MACROETAPA 1 · HOME E ORBE · CACHE V578
...
const SHELL_CACHE='divina-bruxa-v578-shell';
const CONTENT_CACHE='divina-bruxa-v578-content';
const IMAGE_CACHE='divina-bruxa-v578-images';
const OFFLINE_CACHE='divina-bruxa-v578-offline-core';
const PREMIUM_CACHE='divina-bruxa-v578-premium-static';
...
const RELEASE_CRITICAL_PATTERN_V578=/(?:^|\/)(?:app-v208|orb-engine-v208|page-loader-v1|orb-persistent-journey-v565|orb-universal-presence-v526|orbital-menu-v502|supreme-orb-core-v501|tarot-livre-orbe-os-v517)\.js$/;
...
// falhar, a V578 não assume o controle e o worker anterior continua íntegro.
...
const appShellIsValid=async(url,response)=>{
  ...
  return html.length>1024&&/id=["']app["']/.test(html)&&/id=["']home["']/.test(html)&&/app-v208\.js\?v=577/.test(html)&&/divina-essence-release["'] content=["']V578/.test(html)&&/home-essence-v578/.test(html);
};
...
self.addEventListener('fetch',event=>{
  ...
  if(RELEASE_CRITICAL_PATTERN_V578.test(url.pathname)){
