const CACHE='divina-bruxa-v59-orb-menu-clean';
const CORE=['./','./index.html','./styles.css?v=59','./app.js?v=59','./orb-engine.js?v=59','./divina-orb-v48.png?v=59','./orb-mini-v48.png?v=59','./cosmic-background.png','./manifest.webmanifest','./favicon.svg'];
