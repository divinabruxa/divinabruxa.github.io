/* DIVINA BRUXA 2.0 — FLUIDEZ SUPREMA · ORBE VIVA SUPREMA · CACHE V582
...
const SHELL_CACHE='divina-bruxa-v582-shell';
const CONTENT_CACHE='divina-bruxa-v582-content';
const IMAGE_CACHE='divina-bruxa-v582-images';
const OFFLINE_CACHE='divina-bruxa-v582-offline-core';
const PREMIUM_CACHE='divina-bruxa-v582-premium-static';
...
// falhar, a V582 não assume o controle e o worker anterior continua íntegro.
...
const appShellIsValid=async(url,response)=>{
  ...
  return html.length>1024&&/id=["']app["']/.test(html)&&/id=["']home["']/.test(html)&&/app-v208\.js\?v=582/.test(html);
};
...
self.addEventListener('fetch',event=>{
  ...
  if(RELEASE_CRITICAL_PATTERN_V582.test(url.pathname)){
