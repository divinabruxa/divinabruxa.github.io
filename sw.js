/* DIVINA BRUXA 2.0 — FLUIDEZ SUPREMA · BALÕES MÁGICOS VIVOS · CACHE V586
...
const SHELL_CACHE='divina-bruxa-v586-shell';
const CONTENT_CACHE='divina-bruxa-v586-content';
const IMAGE_CACHE='divina-bruxa-v586-images';
const OFFLINE_CACHE='divina-bruxa-v586-offline-core';
const PREMIUM_CACHE='divina-bruxa-v586-premium-static';
...
const RELEASE_CRITICAL_PATTERN_V586=/(?:^|\/)(?:app-v208|experience-message-governor-v580|living-universe-core-v524|magical-bubble-system-v586|orb-engine-v208|page-loader-v1|orb-persistent-journey-v565|orb-universal-presence-v526|orbital-menu-v502|reality-intention-language-v585|supreme-orb-core-v501|tarot-livre-orbe-os-v517|universe-coordinate-law-v583|whit-core-supreme-v527|whit-orb-soul-bridge-v581|whit-presence-v307|whit-signature-v311)\.js$/;
...
const REQUIRED_SHELL=Object.freeze([
  ...
  './app-v208.js','./reality-intention-language-v585.js','./reality-intention-language-v585.css',
  './magical-bubble-system-v586.js','./magical-bubble-system-v586.css',
  './experience-message-governor-v580.js','./whit-orb-soul-bridge-v581.js','./navigation.js','./route-registry-v180.js','./page-loader-v1.js',
  './world-truth-registry-v535.js','./universe-coordinate-law-v583.js','./orb-fluid-navigation-v535.js',
...
// falhar, a V586 não assume o controle e o worker anterior continua íntegro.
...
const FREE_OFFLINE_ASSETS=Object.freeze([
  ...
  './library-deep-v332.js','./library-deep-v332.css','./school-library-supreme-v555.css',
  ...
  './skin-registry-v12.js','./skin-universal-v10.js','./skin-catalog-v6.js',
  './divina-orb-fast-v1.webp','./divina-orb-thumb-v1.webp',
  './laboratorio-fisico-v547.js','./laboratorio-fisico-v547.css','./MATRIZ-FISICA-V547.json'
]);
...
const PUBLIC_OFFLINE_PAGES=Object.freeze([
  ...
  './privacidade-e-dados.html','./laboratorio-fisico-v547.html'
]);
...
const offlineStatus=async(existingFailures=[])=>{
  ...
  return {
    ...
    worlds:{tarot:true,dailyPreviouslyRevealed:true,library:true,journalLocal:true,whitLocal:true,musicText:true,videosText:true,currentSkin:true},
    premium:{preparedCache:PREMIUM_CACHE,requiresServerEntitlement:true,grantsEntitlement:false},
    onlineOnly:{whitOnline:true,billing:true,admin:true,consultationSubmit:true,accountAuthority:true,spotifyPlayer:true,youtubePlayer:true,mediaPublication:true}
  };
};
...
const appShellIsValid=async(url,response)=>{
  ...
  return html.length>1024&&/id=["']app["']/.test(html)&&/id=["']home["']/.test(html)&&/app-v208\.js\?v=586-baloes-vivos/.test(html);
};
...
self.addEventListener('fetch',event=>{
  ...
  if(RELEASE_CRITICAL_PATTERN_V586.test(url.pathname)){
