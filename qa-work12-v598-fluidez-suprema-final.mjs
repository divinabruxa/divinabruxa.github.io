/* DIVINA BRUXA — WORK12 · QA ESTRUTURAL · MACROETAPA 10 V598 */
...
check('release:meta-v598',index.includes('name="divina-fluidity-release" content="V598"'));
check('release:work12-v598',index.includes('name="divina-work12" content="V598"'));
check('release:macro-ten',index.includes('data-macroetapa="work12-10-fluidez-suprema-final"'));
...
check('release:style-query',index.includes('work12-final-continuity-v598.css?v=598-work12-final'));
check('release:worker-query',index.includes("register('./sw.js?v=598'"));
check('release:inline-bootstrap',index.includes("__divinaSWBootstrap='v598-work12-inline'"));
check('release:inline-ready',index.includes("work12Boot='ready-v598'"));
check('release:inline-recovery',index.includes("work12Boot='released-v598'"));
check('release:inline-recovery-source',index.includes("source:'work12-final-v598'"));
check('release:app-bootstrap',app.includes("__divinaSWBootstrap = 'v598-work12-app'"));
check('release:worker-version',worker.includes('const VERSION = 598;'));
...
check('worker:cache-v598',worker.includes('divina-bruxa-work12-v598-final-fluidity'));
...
check('worker:final-styles',worker.includes("'./work12-final-continuity-v598.css?v=598-work12-final'"));
...
const coordinates=await import(`${pathToFileURL(path.join(root,'universe-coordinate-law-v583.js')).href}?qa=v598-final`);
...
const vector=coordinates.universeJourneyVectorV583('home','tarot',598);
...
console.log(JSON.stringify({
  release:'V598',work:'WORK12',macroStage:'10-of-10 / Fluidez Suprema Final',
