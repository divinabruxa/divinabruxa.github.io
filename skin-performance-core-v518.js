/* DIVINA BRUXA — MACROETAPA 4/4 · SKINS, DESEMPENHO E ACABAMENTO V518
   ...
   desenho aprovado da Chama V516 e governa o orçamento Retina do Universo Vivo V521.
*/
...
export class SkinPerformanceCoreV518 {
  ...
  applyPalette(requested, { animate=true } = {}) {
    ...
    (globalThis.divinaLivingUniverseV521 || globalThis.divinaLivingUniverseV520 || globalThis.divinaLivingUniverseV519 || globalThis.divinaLivingUniverseV516)?.syncPalette?.(true);
  ...
  applyBudget(reason = 'adaptive') {
    const universe = globalThis.divinaLivingUniverseV521 || globalThis.divinaLivingUniverseV520 || globalThis.divinaLivingUniverseV519 || globalThis.divinaLivingUniverseV516;
    const mobile = innerWidth < 700;
    const budgets = {
      cinematic:{ fps:60, scale:mobile ? 0.80 : 0.86 },
      balanced:{ fps:60, scale:mobile ? 0.72 : 0.80 },
      protected:{ fps:reducedMotion() ? 24 : 40, scale:0.56 }
    };
  ...
  assertIntegrity() {
    ...
    const canvases = document.querySelectorAll('#divinaLivingUniverseV521 canvas, #divinaLivingUniverseV520 canvas, #divinaLivingUniverseV519 canvas, #divinaLivingUniverseV516 canvas');
  ...
  status() {
    ...
    return Object.freeze({
      ...
      activeUniverseFile:'v521',
      approvedFlameLineage:'v516-preserved-inside-v521',
