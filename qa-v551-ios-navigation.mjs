...
check(app.startsWith('/* DIVINA BRUXA 4.0 — FLUIDEZ SUPREMA · MACROETAPA 3/14 · V551'),'app:release');
check(app.includes("release:'V551'")&&app.includes("currentMacroStage:'3-of-14'"),'app:macroetapa');
check(index.includes('ios-navigation-v551.css?v=551')&&index.includes('app-v208.js?v=551'),'index:movimento-v551');
check(index.includes('sw.js?v=551')&&index.includes('manifest.webmanifest?v=551'),'index:cache-v551');
check(sw.includes('const VERSION=551')&&sw.includes('divina-bruxa-v551-shell')&&sw.includes("'./ios-navigation-v551.css'"),'sw:atomico-v551');
...
console.log(`V551 Navegação iOS: ${passed}/${total} verificações aprovadas.`);
