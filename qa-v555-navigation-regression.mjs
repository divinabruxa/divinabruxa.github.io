...
check(app.startsWith('/* DIVINA BRUXA 4.0 — FLUIDEZ SUPREMA · MACROETAPA 7/14 · V555'),'app:release');
check(app.includes("release:'V555'")&&app.includes("currentMacroStage:'7-of-14'"),'app:macroetapa');
check(index.includes('ios-navigation-v551.css?v=551')&&index.includes('app-v208.js?v=555'),'index:movimento-v551');
check(index.includes('sw.js?v=555')&&index.includes('manifest.webmanifest?v=555'),'index:cache-v551');
check(sw.includes('const VERSION=555')&&sw.includes('divina-bruxa-v555-shell')&&sw.includes("'./ios-navigation-v551.css'"),'sw:atomico-v551');
...
console.log(`V555 Regressão de Navegação iOS: ${passed}/${total} verificações aprovadas.`);
