...
check(app.startsWith('/* DIVINA BRUXA 4.0 — FLUIDEZ SUPREMA · MACROETAPA 6/14 · V554'),'app:release');
check(app.includes("release:'V554'")&&app.includes("currentMacroStage:'6-of-14'"),'app:macroetapa');
check(index.includes('ios-navigation-v551.css?v=551')&&index.includes('app-v208.js?v=554'),'index:movimento-v551');
check(index.includes('sw.js?v=554')&&index.includes('manifest.webmanifest?v=554'),'index:cache-v551');
check(sw.includes('const VERSION=554')&&sw.includes('divina-bruxa-v554-shell')&&sw.includes("'./ios-navigation-v551.css'"),'sw:atomico-v551');
...
console.log(`V554 Regressão de Navegação iOS: ${passed}/${total} verificações aprovadas.`);
