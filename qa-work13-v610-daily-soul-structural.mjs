...
ok(app.includes('realitySouls:2'), 'duas realidades concluídas');
...
ok(count(core,/^\s*'\.\//gm) === 49, '49 ativos atômicos');
ok(sw.includes("CACHE_NAME = 'divina-bruxa-work13-v610-carta-do-dia-soul'"), 'cache próprio');
