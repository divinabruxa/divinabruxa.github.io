...
check(app.startsWith('/* DIVINA BRUXA 4.0 — FLUIDEZ SUPREMA · MACROETAPA 10/14 · V558'),'app:release');
check(app.includes("release:'V558'")&&app.includes("currentMacroStage:'10-of-14'"),'app:macroetapa');
check(index.includes('ios-navigation-v551.css?v=551')&&index.includes('app-v208.js?v=558'),'index:movimento-v551');
check(index.includes('sw.js?v=558')&&index.includes('manifest.webmanifest?v=558'),'index:cache-v551');
check(sw.includes('const VERSION=558')&&sw.includes('divina-bruxa-v558-shell')&&sw.includes("'./ios-navigation-v551.css'"),'sw:atomico-v551');
...
console.log(`V558 Regressão de Navegação iOS: ${passed}/${total} verificações aprovadas.`);
