...
const realityOrb = safely('motor da Orbe V207', () => new RealityOrbEngine($('#orbCanvas'), {
...
window.divinaOrbV207 = Object.freeze({
  version: 207,
  engine: realityOrb,
