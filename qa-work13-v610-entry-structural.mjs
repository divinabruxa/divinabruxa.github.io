...
ok(html.includes('name="divina-work13-correction" content="V613-MENU-GLOBAL-VIVO-PERSISTENTE"'), 'correção permanece no WORK13');
...
ok(html.includes('app-v208.js?v=613-menu-global-vivo'), 'aplicação ligada');
ok(html.includes("./sw.js?v=613-menu-global-vivo"), 'worker ligado');
...
ok(app.includes("dataset.work13Macro = 'menu-global-vivo-persistente'"), 'macro do WORK13 atualizado');
...
ok(sw.includes("CACHE_NAME = 'divina-bruxa-work13-v613-menu-global-vivo'"), 'cache isolado');
...
console.log(`PASS ${checks}/${checks} — menu global vivo em todas as páginas no WORK13 V613`);
