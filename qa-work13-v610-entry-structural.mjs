...
ok(html.includes('name="divina-work13-correction" content="V622-LOJA-CASA-DAS-ESCOLHAS-VIVAS"'), 'renovação permanece no WORK13');
...
ok(html.includes('app-v208.js?v=622-loja-casa-das-escolhas-vivas'), 'aplicação ligada');
ok(html.includes("./sw.js?v=622-loja-casa-das-escolhas-vivas"), 'worker ligado');
...
ok(count(core, /^\s*'\.\//gm) === 72, '72 ativos centrais');
ok(sw.includes("CACHE_NAME = 'divina-bruxa-work13-v622-loja-casa-das-escolhas-vivas'"), 'cache isolado');
...
console.log(`PASS ${checks}/${checks} — menu V613 preservado dentro do WORK13 V622`);
