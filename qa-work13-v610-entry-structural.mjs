...
ok(html.includes('name="divina-work13-correction" content="V617-TIRAGENS-CONCILIO-DAS-CONSTELACOES"'), 'renovação permanece no WORK13');
...
ok(html.includes('app-v208.js?v=617-tiragens-concilio-das-constelacoes'), 'aplicação ligada');
ok(html.includes("./sw.js?v=617-tiragens-concilio-das-constelacoes"), 'worker ligado');
...
ok(count(core, /^\s*'\.\//gm) === 62, '62 ativos centrais');
ok(sw.includes("CACHE_NAME = 'divina-bruxa-work13-v617-tiragens-concilio-constelacoes'"), 'cache isolado');
...
console.log(`PASS ${checks}/${checks} — menu V613 preservado dentro do WORK13 V617`);
