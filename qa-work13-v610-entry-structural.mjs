...
ok(html.includes('name="divina-work13-correction" content="V618-ESCOLA-JARDIM-DAS-78-SEMENTES"'), 'renovação permanece no WORK13');
...
ok(html.includes('app-v208.js?v=618-escola-jardim-das-78-sementes'), 'aplicação ligada');
ok(html.includes("./sw.js?v=618-escola-jardim-das-78-sementes"), 'worker ligado');
...
ok(count(core, /^\s*'\.\//gm) === 64, '64 ativos centrais');
ok(sw.includes("CACHE_NAME = 'divina-bruxa-work13-v618-escola-jardim-78-sementes'"), 'cache isolado');
...
console.log(`PASS ${checks}/${checks} — menu V613 preservado dentro do WORK13 V618`);
