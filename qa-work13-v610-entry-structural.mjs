...
ok(html.includes('name="divina-work13-correction" content="V616-CARTA-DO-DIA-SANTUARIO-DA-AURORA"'), 'renovação permanece no WORK13');
...
ok(html.includes('app-v208.js?v=616-carta-do-dia-santuario-da-aurora'), 'aplicação ligada');
ok(html.includes("./sw.js?v=616-carta-do-dia-santuario-da-aurora"), 'worker ligado');
...
ok(count(core, /^\s*'\.\//gm) === 60, '60 ativos centrais');
ok(sw.includes("CACHE_NAME = 'divina-bruxa-work13-v616-carta-dia-santuario-aurora'"), 'cache isolado');
...
console.log(`PASS ${checks}/${checks} — menu V613 preservado dentro do WORK13 V616`);
