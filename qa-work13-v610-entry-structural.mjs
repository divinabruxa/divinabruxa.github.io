...
ok(html.includes('name="divina-work13-correction" content="V625-MUSICA-PALCO-DAS-ESTRELAS"'), 'renovação permanece no WORK13');
...
ok(html.includes('app-v208.js?v=625-musica-palco-das-estrelas'), 'aplicação ligada');
ok(html.includes("./sw.js?v=625-musica-palco-das-estrelas"), 'worker ligado');
...
ok(count(core, /^\s*'\.\//gm) === 78, '78 ativos centrais');
ok(sw.includes("CACHE_NAME = 'divina-bruxa-work13-v625-musica-palco-das-estrelas'"), 'cache isolado');
...
console.log(`PASS ${checks}/${checks} — menu V613 preservado dentro do WORK13 V625`);
