...
ok(html.includes('name="divina-work13-correction" content="V623-PREMIUM-SALA-DAS-CHAVES"'), 'renovação permanece no WORK13');
...
ok(html.includes('app-v208.js?v=623-premium-sala-das-chaves'), 'aplicação ligada');
ok(html.includes("./sw.js?v=623-premium-sala-das-chaves"), 'worker ligado');
...
ok(count(core, /^\s*'\.\//gm) === 74, '74 ativos centrais');
ok(sw.includes("CACHE_NAME = 'divina-bruxa-work13-v623-premium-sala-das-chaves'"), 'cache isolado');
...
console.log(`PASS ${checks}/${checks} — menu V613 preservado dentro do WORK13 V623`);
