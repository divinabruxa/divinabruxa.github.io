...
ok(html.includes('name="divina-work13-correction" content="V624-CONTA-CASA-DO-RETORNO"'), 'renovação permanece no WORK13');
...
ok(html.includes('app-v208.js?v=624-conta-casa-do-retorno'), 'aplicação ligada');
ok(html.includes("./sw.js?v=624-conta-casa-do-retorno"), 'worker ligado');
...
ok(count(core, /^\s*'\.\//gm) === 76, '76 ativos centrais');
ok(sw.includes("CACHE_NAME = 'divina-bruxa-work13-v624-conta-casa-do-retorno'"), 'cache isolado');
...
console.log(`PASS ${checks}/${checks} — menu V613 preservado dentro do WORK13 V624`);
