...
check(app.startsWith('/* DIVINA BRUXA 4.0 — FLUIDEZ SUPREMA · MACROETAPA 9/14 · V557'),'app:release');
check(app.includes("release:'V557'")&&app.includes("currentMacroStage:'9-of-14'"),'app:macroetapa');
check(index.includes('ios-navigation-v551.css?v=551')&&index.includes('app-v208.js?v=557'),'index:movimento-v551');
check(index.includes('sw.js?v=557')&&index.includes('manifest.webmanifest?v=557'),'index:cache-v551');
check(sw.includes('const VERSION=557')&&sw.includes('divina-bruxa-v557-shell')&&sw.includes("'./ios-navigation-v551.css'"),'sw:atomico-v551');
...
console.log(`V557 Regressão de Navegação iOS: ${passed}/${total} verificações aprovadas.`);
