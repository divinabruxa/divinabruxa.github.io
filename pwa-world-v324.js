/* DIVINA BRUXA 3.0 — SABEDORIA VIVA PROFUNDA · CORTE V539 / PWA V324
...
const installStyle=()=>{
  ...
  link.id=STYLE_ID;link.rel='stylesheet';link.href='./pwa-resilience-v324.css?v=539';
...
const setupServiceWorker=()=>{
  ...
  globalThis.__divinaSWBootstrap='v539';
  const register=()=>navigator.serviceWorker.register('./sw.js?v=539',{updateViaCache:'none'})
    .then(registration=>{
      dispatchEvent(new CustomEvent('divina:pwa-ready',{detail:{scope:registration.scope,version:VERSION,recovery:'sabedoria-viva-profunda-v539'}}));
      registration.update().catch(()=>{});
      return registration;
    })
    .catch(error=>console.error('[Divina] PWA V539 isolado indisponível',error));
