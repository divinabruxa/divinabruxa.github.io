/* DIVINA BRUXA 3.0 — BIBLIOTECA PÚBLICA · CORTE V544 / PWA V324
...
const setupServiceWorker=()=>{
  ...
  globalThis.__divinaSWBootstrap='v544';
  const register=()=>navigator.serviceWorker.register('./sw.js?v=544',{updateViaCache:'none'})
    .then(registration=>{
      dispatchEvent(new CustomEvent('divina:pwa-ready',{detail:{scope:registration.scope,version:VERSION,recovery:'biblioteca-publica-v544'}}));
      registration.update().catch(()=>{});
      return registration;
    })
    .catch(error=>console.error('[Divina] PWA V544 isolado indisponível',error));
