/* DIVINA BRUXA — WORK13 V623 · QA DO BOOT RECUPERÁVEL */
...
check('boot:work13-meta-v623', indexSource.includes('name="divina-work13" content="V623"'));
check('boot:work12-meta-v600', indexSource.includes('name="divina-work12" content="V600"'));
check('boot:app-v623', indexSource.includes('app-v208.js?v=623-premium-sala-das-chaves'));
check('boot:worker-v623', indexSource.includes("register('./sw.js?v=623-premium-sala-das-chaves'"));
check('boot:v623-bootstrap', indexSource.includes("__divinaSWBootstrap='v623-premium-sala-das-chaves-inline'"));
...
check('boot:registers-v623', healthy.registrations.some(item => item.url === './sw.js?v=623-premium-sala-das-chaves'));
...
console.log(JSON.stringify({
  release:'V623',
  work:'WORK13',
  macroStage:'WORK13 / premium-sala-das-chaves-boot-runtime',
