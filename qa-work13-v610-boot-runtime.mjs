/* DIVINA BRUXA — WORK13 V619 · QA DO BOOT RECUPERÁVEL */
...
check('boot:work13-meta-v619', indexSource.includes('name="divina-work13" content="V619"'));
check('boot:work12-meta-v600', indexSource.includes('name="divina-work12" content="V600"'));
check('boot:app-v619', indexSource.includes('app-v208.js?v=619-diario-camara-da-tinta-viva'));
check('boot:worker-v619', indexSource.includes("register('./sw.js?v=619-diario-camara-da-tinta-viva'"));
check('boot:v619-bootstrap', indexSource.includes("__divinaSWBootstrap='v619-diario-camara-da-tinta-viva-inline'"));
...
check('boot:registers-v619', healthy.registrations.some(item => item.url === './sw.js?v=619-diario-camara-da-tinta-viva'));
...
console.log(JSON.stringify({
  release:'V619',
  work:'WORK13',
  macroStage:'WORK13 / diario-camara-da-tinta-viva-boot-runtime',
