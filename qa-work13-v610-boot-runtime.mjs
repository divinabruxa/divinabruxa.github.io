/* DIVINA BRUXA — WORK13 V616 · QA DO BOOT RECUPERÁVEL */
...
check('boot:work13-meta-v616', indexSource.includes('name="divina-work13" content="V616"'));
check('boot:work12-meta-v600', indexSource.includes('name="divina-work12" content="V600"'));
check('boot:app-v616', indexSource.includes('app-v208.js?v=616-carta-do-dia-santuario-da-aurora'));
check('boot:worker-v616', indexSource.includes("register('./sw.js?v=616-carta-do-dia-santuario-da-aurora'"));
check('boot:v616-bootstrap', indexSource.includes("__divinaSWBootstrap='v616-carta-do-dia-santuario-da-aurora-inline'"));
...
check('boot:registers-v616', healthy.registrations.some(item => item.url === './sw.js?v=616-carta-do-dia-santuario-da-aurora'));
...
console.log(JSON.stringify({
  release:'V616',
  work:'WORK13',
  macroStage:'WORK13 / carta-do-dia-santuario-da-aurora-boot-runtime',
