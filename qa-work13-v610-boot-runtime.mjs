/* DIVINA BRUXA — WORK13 V615 · QA DO BOOT RECUPERÁVEL */
...
check('boot:work13-meta-v615', indexSource.includes('name="divina-work13" content="V615"'));
check('boot:work12-meta-v600', indexSource.includes('name="divina-work12" content="V600"'));
check('boot:app-v615', indexSource.includes('app-v208.js?v=615-biblioteca-sala-dos-fios-vivos'));
check('boot:worker-v615', indexSource.includes("register('./sw.js?v=615-biblioteca-sala-dos-fios-vivos'"));
check('boot:v615-bootstrap', indexSource.includes("__divinaSWBootstrap='v615-biblioteca-sala-dos-fios-vivos-inline'"));
...
check('boot:registers-v615', healthy.registrations.some(item => item.url === './sw.js?v=615-biblioteca-sala-dos-fios-vivos'));
...
console.log(JSON.stringify({
  release:'V615',
  work:'WORK13',
  macroStage:'WORK13 / biblioteca-sala-dos-fios-vivos-boot-runtime',
