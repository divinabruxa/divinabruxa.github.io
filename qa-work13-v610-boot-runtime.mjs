/* DIVINA BRUXA — WORK13 V620 · QA DO BOOT RECUPERÁVEL */
...
check('boot:work13-meta-v620', indexSource.includes('name="divina-work13" content="V620"'));
check('boot:work12-meta-v600', indexSource.includes('name="divina-work12" content="V600"'));
check('boot:app-v620', indexSource.includes('app-v208.js?v=620-whit-presenca-entre-mundos'));
check('boot:worker-v620', indexSource.includes("register('./sw.js?v=620-whit-presenca-entre-mundos'"));
check('boot:v620-bootstrap', indexSource.includes("__divinaSWBootstrap='v620-whit-presenca-entre-mundos-inline'"));
...
check('boot:registers-v620', healthy.registrations.some(item => item.url === './sw.js?v=620-whit-presenca-entre-mundos'));
...
console.log(JSON.stringify({
  release:'V620',
  work:'WORK13',
  macroStage:'WORK13 / whit-presenca-entre-mundos-boot-runtime',
