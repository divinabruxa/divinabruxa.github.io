/* DIVINA BRUXA — UNIVERSO VIVO · MACROETAPA 1/4 · MOTOR CELESTIAL V520
   ...
   Nuvens orgânicas, constelações completas, gravidade da Orbe e a Chama
   Celestial aprovada compartilham o mesmo canvas — sem foto ou motor extra. */

const VERSION = 520;
const STYLE_ID = 'divinaLivingUniverseV520Styles';
const ROOT_ID = 'divinaLivingUniverseV520';
...
function installStyle() {
  ...
  link.id = STYLE_ID;
  link.rel = 'stylesheet';
  link.href = './living-universe-core-v520.css?v=520';
...
class LivingUniverseCoreV520 {
  constructor() {
    ...
    this.root.className = 'db520-universe';
    this.root.setAttribute('aria-hidden', 'true');
    this.root.innerHTML = '<canvas data-living-universe-canvas></canvas><span class="db520-universe__veil"></span>';
    ...
    document.documentElement.dataset.livingUniverse = 'v520';
    document.body.classList.remove('db516-universe-active','db519-universe-active');
    document.body.classList.add('db520-universe-active');
    ...
    try {
      ...
      const fragment = this.createShader(this.gl.FRAGMENT_SHADER, `
        ...
        void main(){
          ...
          nebula*=mix(0.50,1.18,edge)*u_density*(1.0-darkDust*0.28)*breath*cloudResponse;
  ...
  status() {
    return Object.freeze({
      ...
      staticUniverseImage:false,
      globalAcrossRoutes:true,
      oneUniverseCanvas:document.querySelectorAll('#divinaLivingUniverseV520 canvas').length === 1,
      targetFps:this.targetFps,
...
export function createLivingUniverseV520() {
  if (globalThis.divinaLivingUniverseV520?.status) return globalThis.divinaLivingUniverseV520;
  const former = globalThis.divinaLivingUniverseV519 || globalThis.divinaLivingUniverseV516;
  ...
  document.body?.classList.remove('db516-universe-active','db519-universe-active');
  const universe = new LivingUniverseCoreV520();
