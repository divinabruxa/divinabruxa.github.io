/* DIVINA BRUXA — VERDADE COMERCIAL ÚNICA V200
...
export const COMMERCIAL_TRUTH_V200=Object.freeze({
  release:'V200',truthVersion:'commercial-2026-09-09-v200',consultationPriceTableVersion:'consultas-2026-09-05-v147',billingCatalogVersion:'V191',currency:'BRL',environment:'staging',realBilling:false,checkoutEnabled:false,
  ...
  services:freezeItems([
    {id:'mesa-real-profissional',name:'Mesa Real Profissional',shortName:'Mesa Real',price:250,priceCents:25000,sigil:'✺',duration:'Leitura mais completa',delivery:'Confirmação por e-mail',detail:'Uma leitura ampla para observar ciclos, caminhos, relações e decisões com profundidade.',description:'Leitura profunda e completa da sua realidade atual.',idealFor:'Para quem deseja compreender o cenário inteiro.',includes:Object.freeze(['Mesa completa','Síntese dos caminhos','Orientação final'])},
    {id:'leitura-mentes',name:'Leitura de Mentes',shortName:'Mentes',price:150,priceCents:15000,sigil:'☾',duration:'Leitura direcionada',delivery:'Confirmação por e-mail',detail:'Uma leitura simbólica da dinâmica, dos sinais e das intenções percebidas entre duas pessoas.',description:'Leitura simbólica da dinâmica, intenções e padrões da relação.',idealFor:'Para relações, dúvidas e movimentos emocionais.',includes:Object.freeze(['Dinâmica atual','Intenções simbólicas','Conselho de proteção'])},
    {id:'carta-conselho',name:'Carta de Conselho',shortName:'Conselho',price:100,priceCents:10000,sigil:'◇',duration:'Uma carta profunda',delivery:'Confirmação por e-mail',detail:'Uma carta para iluminar uma situação e oferecer orientação clara, cuidadosa e objetiva.',description:'Uma carta, uma questão e uma orientação objetiva.',idealFor:'Para uma direção essencial no momento presente.',includes:Object.freeze(['Uma carta','Interpretação profunda','Conselho objetivo'])},
    {id:'pergunta-direta',name:'Pergunta Direta',shortName:'Pergunta',price:50,priceCents:5000,sigil:'✦',duration:'Uma questão específica',delivery:'Confirmação por e-mail',detail:'Uma pergunta bem definida para compreender o momento e o próximo passo possível.',description:'Uma pergunta objetiva com orientação simbólica.',idealFor:'Para uma dúvida pontual que pede foco.',includes:Object.freeze(['Uma pergunta','Resposta simbólica','Direção prática'])}
  ])
});
...
export const assertCommercialTruthV200=()=>{
  ...
  if(consultationPrices!=='25000,15000,10000,5000')throw new Error('COMMERCIAL_CONSULTATION_PRICE_DRIFT');
