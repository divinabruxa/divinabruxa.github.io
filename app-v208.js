/* DIVINA BRUXA — REBIRTH R035 · MENU SCENE ZERO V335 · BOOT-SAFE */
...
const startMenuSceneV335 = () => import('./menu-scene-v335.js?v=335')
  .then(module => module.installMenuSceneV335?.({ go }))
  .catch(error => {
    console.error('[Divina] Menu Scene V335 não iniciou', error);
    document.documentElement.dataset.menuRebornError = 'v335';
  });
