/* DIVINA BRUXA — REBIRTH R039 · MENU ORBE VISIBLE V339 · BOOT-SAFE */
...
const startMenuSceneV339 = () => import('./menu-orb-visible-v339.js?v=339')
  .then(module => module.installMenuOrbVisibleV339?.({ go }))
  .catch(error => {
    console.error('[Divina] Menu Orb Visible V339 não iniciou', error);
    document.documentElement.dataset.menuRebornError = 'v339';
  });
